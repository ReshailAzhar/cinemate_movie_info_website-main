...
const MovieDetail = () => {
  ...
  async function getMovie() {
    const res = await fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=3868a677a7e8eb5a58f10397573bd662`)
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        <div className="max-w-sm">
          <img className="rounded" src={movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : Backup} alt={movie.title} />
        </div>
